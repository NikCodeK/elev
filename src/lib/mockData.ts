...
const TWO_MONTH_EVENT_TEMPLATES: EventTemplate[] = [
  {
    type: 'call_started',
    name: 'Call Started',
    description: 'Voice agent connected with candidate Sarah Chen • Session ID: vapi_8x7k2m',
    delayMs: 500,
  },
  {
    type: 'question_asked',
  ...
  },
  {
    type: 'answer_received',
    name: 'Answer Received (Q1)',
    description: 'Transcribed: 312 words • Confidence: 94% • Stored to DB',
    delayMs: 1800,
  },
  {
    type: 'question_asked',
  ...
  },
  {
    type: 'answer_received',
    name: 'Answer Received (Q2)',
    description: 'Transcribed: 428 words • Confidence: 97% • Stored to DB',
    delayMs: 2000,
  },
  {
    type: 'question_asked',
  ...
  },
  {
    ...
    description: 'Transcribed: 241 words • Confidence: 92% • Stored to DB',
    delayMs: 1500,
  },
  {
    type: 'call_ended',
    name: 'Call Ended',
    description: 'Interview completed • Duration: 8:24 • Recording saved',
    delayMs: 800,
  },
  {
    type: 'transcript_ready',
    name: 'Transcript Ready',
    description: 'Full transcript: 981 words • Quality Score: 94% • Persisted',
    delayMs: 1200,
  },
  {
    type: 'evaluation_done',
    name: 'Evaluation Complete',
    description: 'AI analysis done • Model: Claude 3.5 • Rubric v2.3 applied',
    delayMs: 2000,
  },
  {
    type: 'slack_sent',
    name: 'Slack Notification',
    description: 'Team notified in #recruiting-pipeline • Delivery confirmed',
    delayMs: 500,
  },
];
...
const FOUR_MONTH_EVENT_TEMPLATES: EventTemplate[] = [
  {
    type: 'call_started',
    name: 'Call Started',
    description: 'Voice agent connected • Session: vapi_8x7k2m • Consent recorded',
    delayMs: 500,
  },
  {
    type: 'question_asked',
    name: 'Question Asked (Q1)',
    description: 'Technical Q1 from approved rubric v2.3 • Bias-checked',
    delayMs: 1000,
  },
  {
    type: 'answer_received',
    name: 'Answer Received (Q1)',
    description: '312 words • 94% confidence • Encrypted • Audit logged',
    delayMs: 1500,
  },
  {
    type: 'question_asked',
    name: 'Question Asked (Q2)',
    description: 'Problem-solving Q2 • Adaptive follow-up enabled',
    delayMs: 800,
  },
  {
    type: 'answer_received',
    name: 'Answer Received (Q2)',
    description: '428 words • 97% confidence • PII redacted • Audit logged',
    delayMs: 1800,
  },
  {
    type: 'question_asked',
    name: 'Question Asked (Q3)',
    description: 'Motivation Q3 • Culture-fit weighted per rubric',
    delayMs: 800,
  },
  {
    type: 'answer_received',
    name: 'Answer Received (Q3)',
    description: '241 words • 92% confidence • Sentiment analyzed',
    delayMs: 1200,
  },
  {
    type: 'question_asked',
  ...
  },
  {
    ...
    description: '186 words • Depth score: 8.2/10 • Cross-validated',
    delayMs: 1500,
  },
  {
    type: 'call_ended',
    name: 'Call Ended',
    description: 'Duration: 11:42 • Recording encrypted (AES-256) • GDPR compliant',
    delayMs: 600,
  },
  {
    type: 'transcript_ready',
    name: 'Transcript Ready',
    description: '1,167 words • Quality: 95% • Version-controlled • Searchable',
    delayMs: 1000,
  },
  {
    type: 'evaluation_done',
    name: 'Multi-Model Evaluation',
    description: 'Claude + GPT-4 consensus • Calibrated against 847 past interviews',
    delayMs: 2500,
  },
  {
    type: 'slack_sent',
    name: 'Multi-Channel Notification',
    description: 'Slack + Email + ATS update • All confirmations received',
    delayMs: 400,
  },
];
...
const FOUR_MONTH_CANDIDATE_REPORT: CandidateReport = {
  ...
  summary: [
    ...
    'Led successful monolith→microservices migration, reducing deploy time by 70%',
...
export const EVENT_EXPLANATIONS: Record<PipelineEventType, EventExplanation> = {
  call_started: {
    ...
    inProduction: {
      ...
      dataFlow: [
        ...
        'Kandidat nimmt ab → Vapi sendet "call.started" Webhook',
        'n8n empfängt den Webhook und erstellt einen Interview-Record',
  ...
  question_asked: {
    ...
    inProduction: {
      ...
      dataFlow: [
        'Vapi Voice Agent spricht die nächste Frage aus dem Prompt',
  ...
  answer_received: {
    ...
    summary: 'Die Antwort des Kandidaten wird in Echtzeit transkribiert und gespeichert. Vapi nutzt Whisper für Speech-to-Text mit hoher Genauigkeit.',
    inProduction: {
      trigger: 'Vapi Webhook: "speech.transcript.final" nach Sprechpause des Kandidaten',
      dataFlow: [
        'Kandidat spricht seine Antwort',
        'Vapi streamt Audio zu Whisper für Echtzeit-Transkription',
      ...
      errorHandling: 'Bei schlechter Audioqualität: Confidence Score wird gespeichert. Unter 70% Confidence: Antwort wird für manuelle Review markiert.',
    },
  },
  ...
  call_ended: {
    ...
    summary: 'Das Interview ist abgeschlossen. Der Voice Agent verabschiedet sich und die Verbindung wird getrennt. Alle Daten werden für die Auswertung vorbereitet.',
    inProduction: {
      trigger: 'Vapi Webhook: "call.ended" mit Grund (completed, error, timeout)',
      dataFlow: [
        'Voice Agent spricht Verabschiedung',
        'Verbindung wird beendet → Webhook wird gesendet',
      ...
      errorHandling: 'Bei unerwartetem Abbruch: Interview wird als "incomplete" markiert. Kandidat erhält Option für neuen Termin.',
    },
  },
  ...
  transcript_ready: {
    ...
    summary: 'Alle Einzelantworten werden zu einem vollständigen Interview-Transkript zusammengeführt. Das Transkript wird strukturiert und für die AI-Analyse vorbereitet.',
    inProduction: {
      ...
      dataFlow: [
        ...
        'Vollständiges Dokument wird erstellt (Frage + Antwort Paare)',
        'Transkript wird gespeichert',
        'Nächster Workflow-Schritt wird getriggert: AI Evaluation',
      ],
      technologies: ['n8n Workflow', 'Airtable/Notion', 'HTTP Request Node'],
      errorHandling: 'Bei fehlenden Antworten: Transkript wird mit Lücken-Markierung erstellt. Quality Score wird berechnet.',
    },
  },
  ...
  evaluation_done: {
    ...
    summary: 'Eine AI (Claude/GPT) analysiert das vollständige Transkript und erstellt eine strukturierte Bewertung mit Scores, Stärken, Risiken und einer Empfehlung.',
    inProduction: {
      trigger: 'n8n Workflow: Nach Transkript-Aggregation',
      dataFlow: [
        'n8n lädt das vollständige Transkript',
  ...
  slack_sent: {
    ...
    summary: 'Das Hiring-Team wird automatisch über Slack informiert. Die Nachricht enthält eine Zusammenfassung und einen Link zum vollständigen Report.',
    inProduction: {
      trigger: 'n8n Workflow: Nach erfolgreicher Evaluation',
      dataFlow: [
        'n8n Evaluation-Workflow löst Slack-Node aus',
        'Message wird mit Report-Summary formatiert',
        'Slack API wird via n8n Slack Node aufgerufen',
        'Message enthält Kandidaten-Info, Scores und Link',
        'Delivery Status wird geloggt',
      ],
      technologies: ['n8n Slack Node', 'Slack API', 'Webhook'],
      errorHandling: 'Bei Slack API Fehler: n8n Retry. Alternative Kanäle (Email) als Fallback.',
    },
  },
};
